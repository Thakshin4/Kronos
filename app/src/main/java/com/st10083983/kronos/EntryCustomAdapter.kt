...
import com.st10083983.kronos.KEntryReportItems
import com.st10083983.kronos.R

class EntryCustomAdapter(private val mList: List<KEntryReportItems>) : RecyclerView.Adapter<EntryCustomAdapter.ViewHolder>() {
